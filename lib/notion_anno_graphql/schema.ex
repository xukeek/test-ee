defmodule NotionAnnoGraphQL.Schema do
  use Absinthe.Schema

  alias NotionAnno.Repo

  import_types(Absinthe.Type.Custom)
  import_types(NotionAnnoGraphQL.Application.Types)
  ...
  def middleware(middleware, _, _) do
    [NewRelic.Absinthe.Middleware, NotionAnnoGraphQL.Middleware.OperationNameLogger] ++ middleware
  end
end
