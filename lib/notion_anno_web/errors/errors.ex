defmodule NotionAnnoWeb.Errors do
  alias Ecto.Changeset
  alias NotionAnnoWeb.Errors.View
  ...
  defp translate_error({message, options}) do
    if options[:count] do
      Gettext.dngettext(NotionAnno.Gettext, "errors", message, message, options[:count], options)
    else
      Gettext.dgettext(NotionAnno.Gettext, "errors", message, options)
    end
  end
