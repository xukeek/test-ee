...
WORKDIR "/opt/notion_anno"
RUN chown nobody /opt/notion_anno

# Only copy the final release from the build stage
COPY --from=otp-builder --chown=nobody:root /app/_build/prod/rel/notion_anno ./

USER nobody

CMD ["/opt/notion_anno/bin/server"]
